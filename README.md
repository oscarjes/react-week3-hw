# Project 3 - *Stripe Plus*

**Stripe Plus** is an app using the [Stripe API](https://stripe.com/docs/api).
...
<img src='StripePlus.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
